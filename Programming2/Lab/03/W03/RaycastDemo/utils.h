...
#pragma region CollisionFunctionality
	struct HitInfo
	{
		float lambda;			// Where on the ray the intersection happens (between 0 (beggining) and 1 (at the end))
		Point2f intersectPoint;
		Vector2f normal;		// Perpendicular line to the surface with length of 1
	};
