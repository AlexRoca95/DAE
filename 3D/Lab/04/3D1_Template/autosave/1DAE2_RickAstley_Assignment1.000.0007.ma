...
//Name: 1DAE2_RickAstley_Assignment1.000.0007.ma
//Last modified: Wed, Jul 20, 2022 07:50:39 PM
//Codeset: 1252
requires maya "2022";
...
fileInfo "UUID" "F31B7BA1-4F34-1DB4-979D-F4924914DF13";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "CBB20537-40F8-A23F-4B21-26837A14FFF1";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -7.577330129142541 2.5170330170126465 -10.435218277234073 ;
	setAttr ".r" -type "double3" -8.1383526783715006 -507.39999999963015 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "6CB0EF23-4C47-136F-7BC7-2C89212700F0";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 12.663481459411742;
...
createNode transform -n "pCube1";
	rename -uid "9DAA6749-43E8-646B-AC01-DE949EE74727";
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	rename -uid "47A55C0D-40DD-26C8-CF9A-25BF222E2325";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode polyCube -n "polyCube1";
	rename -uid "B22D3DE6-4ACC-2C38-BCFA-1693D65C4E2C";
	setAttr ".cuv" 4;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
// End of 1DAE2_RickAstley_Assignment1.000.0007.ma
